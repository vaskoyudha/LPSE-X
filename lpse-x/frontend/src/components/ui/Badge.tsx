...
export function Badge({ level, size = 'md', className = '', pulse = false }: BadgeProps) {
  ...
  if (level === 'Aman') {
    ...
    colorClass = 'bg-red-950 text-red-200 ring-1 ring-red-800 shadow-[0_0_8px_rgba(244,63,94,0.5)]';
  }
